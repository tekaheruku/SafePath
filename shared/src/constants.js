...
export const API_ENDPOINTS = {
    ...
    REPORTS_GET: (id) => `/reports/${id}`,
    REPORTS_UPDATE: (id) => `/reports/${id}`,
    REPORTS_DELETE: (id) => `/reports/${id}`,
    REPORTS_COMMENTS: (id) => `/reports/${id}/comments`,
    STREET_RATE: "/streets/rate",
    STREET_RATINGS: "/streets/ratings",
    STREET_STATS: (name) => `/streets/stats/${name}`,
