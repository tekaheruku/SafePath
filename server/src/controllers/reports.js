...
import { createReportSchema, updateReportSchema, paginationSchema, validateSync, } from '@safepath/shared/validators';
...
export class ReportController {
    ...
    static async createReport(req, res) {
        try {
            ...
            SocketEventBroadcaster.broadcastNewReport(report);
    ...
    static async deleteReport(req, res) {
        try {
            ...
            await ReportService.deleteReport(req.params.id, req.user.id, req.user.role);
            // Broadcast deletion
