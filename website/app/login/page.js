      ...
      <div className="max-w-md w-full bg-theme-panel rounded-2xl p-8 border border-theme-border shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input type="email" required className="w-full bg-theme-panel/50 border border-theme-border rounded-lg px-4 py-3 text-theme-fg focus:ring-2 focus:ring-indigo-500 outline-none transition-all" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)}/>
          </div>
          <div>
            <label className="block text-sm font-medium text-theme-fg-muted mb-2">Password</label>
            <input type="password" required className="w-full bg-theme-panel/50 border border-theme-border rounded-lg px-4 py-3 text-theme-fg focus:ring-2 focus:ring-indigo-500 outline-none transition-all" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)}/>
          </div>
