      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="relative w-full md:w-72">
            <input type="text" placeholder="Search users..." value={search} onChange={(e) => setSearch(e.target.value)} className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-2.5 pl-10 focus:ring-2 focus:ring-indigo-500 outline-none transition-all"/>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-2xl">
          <div className="overflow-x-auto">
            ...
            : 'border-slate-700 text-slate-500 hover:text-slate-300'}`} title="Sort by First Name">
            ...
            ? 'bg-indigo-500/20 border-indigo-500/50 text-indigo-400'
            : 'border-slate-700 text-slate-500 hover:text-slate-300'}`} title="Sort by Last Name">
                  ...
                  <th className="px-6 py-4 font-semibold cursor-pointer group hover:bg-slate-800/50 transition-colors" onClick={() => requestSort('role')}>
                  ...
                  <th className="px-6 py-4 font-semibold cursor-pointer group hover:bg-slate-800/50 transition-colors" onClick={() => requestSort('created_at')}>
                    <div className="flex items-center space-x-1">
                      <span>Created</span>
              ...
              <tbody className="divide-y divide-slate-800">
                {loading ? (Array(5).fill(0).map((_, i) => (<tr key={i} className="animate-pulse">
                    ...
                    </tr>))) : processedUsers.length > 0 ? (processedUsers.map((u) => (<tr key={u.id} className="hover:bg-slate-800/30 transition-colors cursor-pointer group" onClick={() => setSelectedUser(u)}>
