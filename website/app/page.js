...
export default function Home() {
    ...
    return (<div className="space-y-4 pb-4">
      <header className="space-y-1">
        ...
        {!user && (<p className="text-theme-fg-muted text-sm md:text-base max-w-2xl leading-tight">
      ...
      {!user && (<section className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
