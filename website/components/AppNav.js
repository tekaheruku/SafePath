...
const AppNav = () => {
    ...
    return (<nav className="border-b border-slate-800 bg-slate-950/50 backdrop-blur-md sticky top-0 z-[9999]">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          {user ? (<div className="flex items-center space-x-4">
              ...
              <Link href="/settings" className="p-2 rounded-full bg-slate-800 hover:bg-slate-700 text-sm font-semibold transition-all" title="Settings" aria-label="Settings">
                ⚙️
              </Link>
              ...
              <Link href="/login" className="px-4 py-2 rounded-full bg-slate-800 hover:bg-slate-700 text-sm font-semibold transition-all duration-200 hover:scale-[1.02] active:scale-95">
                Sign In
              </Link>
